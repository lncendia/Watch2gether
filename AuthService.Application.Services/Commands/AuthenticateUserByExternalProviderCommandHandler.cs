...
public class AuthenticateUserByExternalProviderCommandHandler(UserManager<UserData> userManager)
    : IRequestHandler<AuthenticateUserByExternalProviderCommand, UserData>
{
    /// <summary>
    ...
    public async Task<UserData> Handle(AuthenticateUserByExternalProviderCommand request,

...
/// </summary>
public class ConnectYoutubeRoomCommandHandler(IUnitOfWork unitOfWork)
    : IRequestHandler<ConnectYoutubeRoomCommand, RoomServerDto>
{
    public async Task<RoomServerDto> Handle(ConnectYoutubeRoomCommand request, CancellationToken cancellationToken)
    {

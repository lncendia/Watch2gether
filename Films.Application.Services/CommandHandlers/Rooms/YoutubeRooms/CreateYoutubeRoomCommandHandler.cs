...
/// </summary>
public class CreateYoutubeRoomCommandHandler(IUnitOfWork unitOfWork)
    : IRequestHandler<CreateYoutubeRoomCommand, RoomServerDto>
{
    public async Task<RoomServerDto> Handle(CreateYoutubeRoomCommand request, CancellationToken cancellationToken)
    {

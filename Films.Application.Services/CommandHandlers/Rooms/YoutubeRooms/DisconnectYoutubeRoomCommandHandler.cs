...
/// </summary>
public class DisconnectYoutubeRoomCommandHandler(IUnitOfWork unitOfWork)
    : IRequestHandler<DisconnectYoutubeRoomCommand>
{
    public async Task Handle(DisconnectYoutubeRoomCommand request, CancellationToken cancellationToken)
    {

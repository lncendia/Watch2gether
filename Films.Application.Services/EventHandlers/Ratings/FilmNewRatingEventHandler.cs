...
namespace Films.Application.Services.EventHandlers.Ratings;

public class FilmNewRatingEventHandler(IUnitOfWork unitOfWork) : INotificationHandler<NewRatingDomainEvent>
{

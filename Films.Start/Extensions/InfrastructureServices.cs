...
using Films.Start.Application.Abstractions.Common.Interfaces;
using Films.Start.Application.Abstractions.MovieApi.Interfaces;
using Films.Start.Infrastructure.Mailing;
using Films.Start.Infrastructure.Movie.Abstractions;
using Films.Start.Infrastructure.Movie.Services;
using Films.Start.Infrastructure.PhotoManager;

...
public class FilmDtoBuilder
{
    ...
    private IReadOnlyCollection<CdnDto>? _cdn;
    ...
    public FilmDto Build()
    {
        ...
        if (_cdn == null) throw new InvalidOperationException("builder not formed");

        return new FilmDto(_name, _description, _shortDescription, _rating.Value, _year.Value, _type.Value,
            _posterUri, _genres, _actors, _countries, _directors, _screenwriters, _countSeasons, _countEpisodes, _cdn);
    }
}
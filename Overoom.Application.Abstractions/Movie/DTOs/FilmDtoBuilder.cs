...
public class FilmDtoBuilder
{
    ...
    public FilmDtoBuilder WithWatchlist(bool watchlist)
    {
        _inWatchlist = watchlist;
        return this;
    }

    public FilmDtoBuilder WithUserRating(double rating, int count)
    {
        _userRating = rating;
        _userRatingsCount = count;
        return this;
    }

    public FilmDtoBuilder WithUserScore(double score)
    {
        _userScore = score;
        return this;
    }
    ...
    public FilmDto Build()
    {
        ...
        if (_userRatingsCount == null) throw new InvalidOperationException("builder not formed");
        ...
        return new FilmDto(_id.Value, _name, _year.Value, _type.Value, _posterUri, _description, _rating.Value,
            _userRating.Value, _userScore, _directors, _screenwriters, _genres, _countries, _actors, _countSeasons,
            _countEpisodes, _cdnList, _inWatchlist, _userRatingsCount.Value);
    }
}
...
public class FilmRepository : IFilmRepository
{
    ...
    private FilmModel AddMap(Film film)
    {
        ...
        {
            Genres = film.FilmCollections.Genres.Select(x => new GenreModel {Name = x}).ToList(),
            Countries = film.FilmCollections.Countries.Select(x => new CountryModel {Name = x}).ToList(),
            Directors = film.FilmCollections.Directors.Select(x => new DirectorModel {Name = x}).ToList(),
            ScreenWriters = film.FilmCollections.Screenwriters.Select(x => new ScreenWriterModel {Name = x}).ToList(),
            Actors = film.FilmCollections.Actors

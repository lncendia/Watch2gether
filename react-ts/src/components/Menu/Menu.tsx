...
const Menu = ({user, onFilmSearch, films}: { user?: AuthorizedUser, films:FilmShort[], onFilmSearch: (string) => void }) => {
    return (
        <Navbar expand="xxl">
            <Container>
                <NavLogo href="#"/>
                <Navbar.Toggle aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Переключатель навигации">
                ...
                <Navbar.Collapse id="navbarSupportedContent">
                    ...
                    <Nav>
                        <Nav.Item>
                            <FilmSearch films={films} onFilmSearch={onFilmSearch}/>
                        </Nav.Item>
                        {/*@if (!appAuth.None)*/}
                        {/*{*/}
